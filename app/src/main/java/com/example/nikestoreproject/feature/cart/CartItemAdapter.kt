...
class CartItemAdapter(
    ...
    class PurchaseDetailViewHolder(override val containerView: View) :
        ...
        /*vaghti in safhe takmil shod bbinm ba in methode bind e paein ham kar mikone ya na!*/
/*        fun bind(purchaseDetail: PurchaseDetail) {
            containerView.totalPriceTv.text = formatPrice(purchaseDetail.totalPrice)
            containerView.shippingCostTv.text = formatPrice(purchaseDetail.shipping_cost)
            containerView.payablePriceTv.text = formatPrice(purchaseDetail.payable_price)
        }*/
    }
